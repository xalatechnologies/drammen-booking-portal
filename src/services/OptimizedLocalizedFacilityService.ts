...
export class OptimizedLocalizedFacilityService {
  ...
  static async getRawFacilityById(id: number): Promise<ApiResponse<LocalizedFacility>> {
    try {
      await delay(200);
  ...
  static async getFacilitiesByType(type: string): Promise<ApiResponse<LocalizedFacility[]>> {
    try {
      await delay(250);
  ...
  static async getFacilitiesByArea(area: string): Promise<ApiResponse<LocalizedFacility[]>> {
    try {
      await delay(250);
