...
/**
 * Legacy abstract base repository for Supabase operations
 * Maintained for backward compatibility
 * New code should use BaseRepository from './BaseRepository' instead
...
export abstract class SupabaseRepository<T extends Record<string, any>> {
  ...
  async findAll(
    ...
    try {
      let query = supabaseClient.from(this.tableName as any).select('*', { count: 'exact' });
