      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <span className="font-medium text-gray-700 block">Formål med reservasjonen</span>
          ...
          {reservation.eventType && (
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-medium text-gray-700 block">Type aktivitet</span>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="font-medium text-gray-700 block">Antall deltakere</span>
      ...
      {reservation.specialRequirements && (
        <div className="mt-6 pt-4 border-t border-gray-200">
          <div className="flex items-start gap-3">
            ...
            <div>
              <span className="font-medium text-gray-700 block">Tilleggsopplysninger</span>
