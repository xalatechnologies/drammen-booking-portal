...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex flex-col">
      {/* Header */}
      <header className="bg-gradient-to-r from-[#0B3D91] to-[#0F4CA7] py-1.5 px-3 shadow-md sticky top-0 z-10">
      ...
      <div className="container mx-auto px-2 py-3 max-w-7xl flex-grow overflow-y-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
          {/* Left Column - Search and Facility Types */}
          <div className="lg:col-span-2">
            <h2 className="text-xl font-bold mb-2 text-gray-800">Find a facility to book</h2>
            
            {/* Search Form */}
            <Card className="mb-3 overflow-hidden border-none shadow-md bg-white">
              <CardContent className="p-2 sm:p-3">
                <div className="grid grid-cols-1 gap-2">
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        <Button
                          variant="outline"
                          className={cn(
                            "w-full justify-start text-left font-normal bg-white border-gray-300 h-9",
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <Button 
                      variant="outline" 
                      className="w-full h-9 bg-white border-blue-300 hover:bg-blue-50 text-blue-600"
                    ...
                    <Button 
                      className="w-full h-9 bg-[#F9CB40] hover:bg-[#E6B92E] text-black font-medium"
                    >
            ...
            {/* Facility Types Grid */}
            <h2 className="text-lg font-bold mb-2 text-gray-800">Find facilities near you</h2>
            <FacilityTypeGrid />
            
            {/* Mobile-only notifications section */}
            <div className="lg:hidden mt-4">
              <h3 className="text-base font-bold text-gray-800 flex items-center">
                <BellRing className="h-3.5 w-3.5 mr-1.5 text-blue-600" />
                Notifications
              </h3>
              <Card className="mt-2 border border-blue-100 rounded-md overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <CardContent className="p-2 bg-gradient-to-r from-blue-50 to-white">
                  <div className="flex justify-between items-center">
                    <p className="font-medium text-xs">Your booking for Music room at Halleren is approved</p>
          ...
          <div className="space-y-3 hidden lg:block">
            ...
            <h3 className="text-base font-bold mt-4 text-gray-800">Resource availability</h3>
            <Card className="overflow-hidden shadow-sm border-none">
              <CardContent className="p-2 bg-gradient-to-br from-blue-50 to-white">
            ...
            <Card className="overflow-hidden shadow-sm border-none mt-3">
              <CardContent className="p-2 bg-gradient-to-br from-amber-50 to-white">
                <div className="space-y-2">
                  ...
                  <Button variant="outline" className="w-full bg-white text-blue-700 hover:bg-blue-50 text-xs h-7">
                    Contact support
                  </Button>
                </div>
              </CardContent>
