...
import { Edit3, Trash2, Calendar, Clock, Users, MapPin } from 'lucide-react';
      ...
      {uniqueReservations.map((reservation) => {
        ...
        return (
          <Accordion key={reservation.id} type="single" collapsible className="w-full">
            <AccordionItem value={reservation.id} className="border border-gray-200 rounded-lg bg-white shadow-sm hover:shadow-md transition-shadow">
              <AccordionTrigger className="px-6 py-4 hover:no-underline text-left">
                <div className="flex items-start justify-between w-full">
                  <div className="flex-1 text-left">
                    ...
                    <p className="text-sm text-gray-500 mt-1 truncate">{reservation.purpose}</p>
                  </div>
