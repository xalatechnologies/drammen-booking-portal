  ...
  return <div className="mb-8 rounded-3xl overflow-hidden shadow-strong hover-lift animate-fade-in">
      <div className="relative">
        ...
        <div className="absolute inset-0 gradient-primary opacity-90 flex items-center justify-center">
          <div className="container py-[61px] px-[36px] mx-0 my-[2px] pt-16 text-center">
            <div className="max-w-3xl mx-auto">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-display font-bold text-white mb-4 leading-tight animate-slide-up">
                ...
                <span className="text-navy-200">Drammen Kommune</span>
              </h1>
              <p style={{
              animationDelay: '0.2s'
            }} className="text-base sm:text-lg md:text-xl text-navy-100 max-w-2xl mb-8 animate-slide-up my-[6px] mx-auto">
        ...
        <div className="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-navy-500/20 to-transparent"></div>
      </div>
    </div>;
};
