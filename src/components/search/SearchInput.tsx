    ...
    <div className="relative">
      ...
      <div className="relative group">
        ...
        <Input
          ...
          className="pl-12 h-12 border-2 border-gray-200 focus:border-blue-600 focus:ring-blue-100 rounded-full text-base shadow-sm hover:border-gray-300 transition-all duration-200"
