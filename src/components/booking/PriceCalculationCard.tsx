...
export function PriceCalculationCard({
  ...
  return <Card className="bg-blue-50 border-blue-200">
      <CardContent className="p-4">
        ...
        {!actorType ? <div className="text-blue-700 text-lg">
            Velg aktør type for å beregne pris
          </div> : isLoading ? <div className="text-blue-700 text-lg">
            Beregner pris...
          </div> : calculation ? <div className="space-y-2 text-blue-800">
            ...
            {calculation.discounts.length > 0 && <div className="flex justify-between text-lg text-green-700">
          ...
          </div> : <div className="text-blue-700 text-lg">Ingen prisberegning tilgjengelig</div>}
      </CardContent>
    </Card>;
}