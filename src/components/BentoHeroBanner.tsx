...
const BentoHeroBanner = () => {
  ...
  return (
    <div className="w-full mb-8 overflow-hidden bg-gradient-to-br from-slate-800 via-slate-700 to-blue-800 border-b border-slate-600/50">
      <div className="content-center py-12">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-lg lg:text-xl xl:text-2xl text-slate-200 leading-relaxed max-w-3xl mx-auto font-light">
            {t('hero.subtitle')}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto">
          ...
          <Card className="bg-gradient-to-br from-emerald-50 via-emerald-100 to-teal-100 border-emerald-200 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 group animate-fade-in cursor-pointer transform hover:rotate-1" style={{ animationDelay: '0.2s' }}>
            <CardContent className="p-4 h-full flex flex-col justify-center text-center relative overflow-hidden min-h-[160px]">
              ...
              {/* Step number */}
              <div className="absolute top-2 left-2 w-7 h-7 bg-emerald-600 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-lg group-hover:scale-110 transition-transform duration-300">
                1
              </div>
              
              <div className="w-12 h-12 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-lg relative z-10">
          ...
          <Card className="bg-gradient-to-br from-blue-50 via-blue-100 to-indigo-100 border-blue-200 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 group animate-fade-in cursor-pointer transform hover:-rotate-1" style={{ animationDelay: '0.4s' }}>
            <CardContent className="p-4 h-full flex flex-col justify-center text-center relative overflow-hidden min-h-[160px]">
              ...
              {/* Step number */}
              <div className="absolute top-2 left-2 w-7 h-7 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-lg group-hover:scale-110 transition-transform duration-300">
                2
              </div>
              
              <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-lg relative z-10">
          ...
          <Card className="bg-gradient-to-br from-purple-50 via-purple-100 to-pink-100 border-purple-200 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 group animate-fade-in cursor-pointer transform hover:rotate-1" style={{ animationDelay: '0.6s' }}>
            <CardContent className="p-4 h-full flex flex-col justify-center text-center relative overflow-hidden min-h-[160px]">
              ...
              {/* Step number */}
              <div className="absolute top-2 left-2 w-7 h-7 bg-purple-600 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-lg group-hover:scale-110 transition-transform duration-300">
                3
              </div>
              
              <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-lg relative z-10">
