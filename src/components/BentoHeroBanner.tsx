...
const BentoHeroBanner = () => {
  ...
  return (
    <div className="w-full mb-8 overflow-hidden bg-gradient-to-br from-slate-200 via-blue-100 to-indigo-150 border-b border-slate-200/50">
      <div className="content-center py-12">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-lg lg:text-xl xl:text-2xl text-gray-700 leading-relaxed max-w-3xl mx-auto font-light">
            {t('hero.subtitle')}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto">
          ...
          <Card className="bg-gradient-to-br from-emerald-50 via-emerald-100 to-teal-100 border-emerald-200 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 group animate-fade-in cursor-pointer transform hover:rotate-1" style={{ animationDelay: '0.2s' }}>
            <CardContent className="p-2 h-full flex flex-col justify-center text-center relative overflow-hidden min-h-[120px]">
              ...
              {/* Step number */}
              <div className="absolute top-1 left-1 w-6 h-6 bg-emerald-600 text-white rounded-full flex items-center justify-center text-xs font-bold shadow-lg group-hover:scale-110 transition-transform duration-300">
                1
              </div>
              
              <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center mx-auto mb-1 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-lg relative z-10">
              ...
              <div className="space-y-1 relative z-10">
                ...
                <h3 className="text-sm font-bold text-emerald-900 group-hover:scale-105 transition-transform duration-300">
          ...
          <Card className="bg-gradient-to-br from-blue-50 via-blue-100 to-indigo-100 border-blue-200 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 group animate-fade-in cursor-pointer transform hover:-rotate-1" style={{ animationDelay: '0.4s' }}>
            <CardContent className="p-2 h-full flex flex-col justify-center text-center relative overflow-hidden min-h-[120px]">
              ...
              {/* Step number */}
              <div className="absolute top-1 left-1 w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold shadow-lg group-hover:scale-110 transition-transform duration-300">
                2
              </div>
              
              <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center mx-auto mb-1 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-lg relative z-10">
              ...
              <div className="space-y-1 relative z-10">
                ...
                <h3 className="text-sm font-bold text-blue-900 group-hover:scale-105 transition-transform duration-300">
          ...
          <Card className="bg-gradient-to-br from-purple-50 via-purple-100 to-pink-100 border-purple-200 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 group animate-fade-in cursor-pointer transform hover:rotate-1" style={{ animationDelay: '0.6s' }}>
            <CardContent className="p-2 h-full flex flex-col justify-center text-center relative overflow-hidden min-h-[120px]">
              ...
              {/* Step number */}
              <div className="absolute top-1 left-1 w-6 h-6 bg-purple-600 text-white rounded-full flex items-center justify-center text-xs font-bold shadow-lg group-hover:scale-110 transition-transform duration-300">
                3
              </div>
              
              <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-1 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-lg relative z-10">
              ...
              <div className="space-y-1 relative z-10">
                ...
                <h3 className="text-sm font-bold text-purple-900 group-hover:scale-105 transition-transform duration-300">
