...
const BentoHeroBanner = () => {
  ...
  return (
    <div className="w-full mb-8 overflow-hidden bg-gradient-to-b from-slate-50/40 to-white">
      <div className="content-center py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto">
          ...
          <Card className="bg-gradient-to-br from-emerald-50 via-emerald-100 to-teal-100 border-emerald-200 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 group animate-fade-in cursor-pointer transform hover:rotate-1" style={{ animationDelay: '0.2s' }}>
            <CardContent className="p-4 h-full flex flex-col justify-center text-center relative overflow-hidden min-h-[180px]">
              ...
              <div className="w-14 h-14 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-lg relative z-10">
                <Search className="h-7 w-7 text-white group-hover:scale-110 transition-transform duration-300" />
                {/* Icon glow effect */}
          ...
          <Card className="bg-gradient-to-br from-blue-50 via-blue-100 to-indigo-100 border-blue-200 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 group animate-fade-in cursor-pointer transform hover:-rotate-1" style={{ animationDelay: '0.4s' }}>
            <CardContent className="p-4 h-full flex flex-col justify-center text-center relative overflow-hidden min-h-[180px]">
              ...
              <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-lg relative z-10">
          ...
          <Card className="bg-gradient-to-br from-purple-50 via-purple-100 to-pink-100 border-purple-200 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 group animate-fade-in cursor-pointer transform hover:rotate-1" style={{ animationDelay: '0.6s' }}>
            <CardContent className="p-4 h-full flex flex-col justify-center text-center relative overflow-hidden min-h-[180px]">
              ...
              <div className="w-14 h-14 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-lg relative z-10">
                <Check className="h-7 w-7 text-white group-hover:scale-110 transition-transform duration-300" />
                {/* Icon glow effect */}
