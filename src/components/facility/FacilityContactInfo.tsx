  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <div className="flex justify-between items-center">
            <span className="text-base text-gray-600">Kapasitet</span>
            <span className="text-base font-medium">{capacity} personer</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-base text-gray-600">Areal</span>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <div className="flex justify-between items-center">
            <span className="text-base text-gray-600">{t.minBooking}</span>
            <Badge variant="outline" className="text-sm">2 {t.hours}</Badge>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-base text-gray-600">{t.maxBooking}</span>
            <Badge variant="outline" className="text-sm">8 {t.hours}</Badge>
          </div>
