...
import { ShoppingCart, X, CreditCard, Calendar, CheckCircle2, User, AlertTriangle, UserCheck } from "lucide-react";
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    className={getFieldError('purpose') ? 'border-red-500 text-base' : 'text-base'}
                  />
                  {getFieldError('purpose') && (
                    <p className="text-sm text-red-600 mt-1">{getFieldError('purpose')}</p>
                  )}
                </div>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex gap-2 pt-2">
                  <Button
                    ...
                    className="flex-1 bg-[#1e3a8a] hover:bg-[#1e40af] text-white text-base"
            ...
            <CardContent>
              {!hasCartItems ? (
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-base font-medium">{t('booking.cart.empty')}</p>
                  <p className="text-sm mt-1 text-gray-400">Fullfør booking for å legge til i handlekurv</p>
                </div>
              ) : (
                <div className="space-y-4">
                  {facilityCartItems.map((item) => (
                    <div key={item.id} className="border rounded-lg p-4 bg-gray-50">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <span className="text-sm text-gray-500">2t</span>
                        </div>
                        <Badge className="bg-green-100 text-green-800 font-medium text-base">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-medium text-base">{getTotalPrice()} kr</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-base text-gray-600">MVA (25%)</span>
                      <span className="font-medium text-base">{Math.round(getTotalPrice() * 0.25)} kr</span>
                    </div>
                    <Separator />
