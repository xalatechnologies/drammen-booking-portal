            ...
            <div className="flex h-full items-center px-6">
                ...
                <div className="flex-1 flex justify-center px-8">
                    <div className="relative w-full max-w-lg">
                        ...
                        <Input
                            placeholder="Søk i bookinger, anlegg..."
                ...
                <div className="flex items-center gap-3">
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <button className="flex items-center gap-3 rounded-full p-1 transition-colors hover:bg-gray-100">
                                <Avatar className="h-9 w-9">
                                    <AvatarImage src="https://i.pravatar.cc/150?u=ola-nordmann" alt="Ola Nordmann" />
                                    <AvatarFallback>ON</AvatarFallback>
                                </Avatar>
                                <div className="hidden md:flex flex-col items-start">
                                    <p className="font-semibold text-sm">Ola Nordmann</p>
                                    <p className="text-xs text-gray-500">Innbygger</p>
                                </div>
                            </button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuSeparator />
                            <DropdownMenuItem onClick={() => navigate('/minside/bruker/profil')}>Min profil</DropdownMenuItem>
